...
import static ua.co.tensa.modules.php.PhpModule.scriptsData;
import static ua.co.tensa.modules.php.PhpModule.scriptsList;
...
public class PHPCommand implements SimpleCommand {
	...
	public boolean hasPermission(final CommandSource sender, String permission) {
		return sender.hasPermission("TENSA.php." + permission) || sender.hasPermission("TENSA.php.*");
	}
