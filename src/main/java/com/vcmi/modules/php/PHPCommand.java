...
import static com.vcmi.modules.php.PhpModule.scriptsData;
import static com.vcmi.modules.php.PhpModule.scriptsList;
...
public class PHPCommand implements SimpleCommand {
	...
	public boolean hasPermission(final CommandSource sender, String permission) {
		return sender.hasPermission("VCMI.php." + permission) || sender.hasPermission("VCMI.php.*");
	}
