...
import static com.vcmi.modules.bash.BashModule.scriptsData;
import static com.vcmi.modules.bash.BashModule.scriptsList;
...
public class BASHCommand implements SimpleCommand {
	...
	public boolean hasPermission(final CommandSource sender, String permission) {
		return sender.hasPermission("VCMI.bash." + permission) || sender.hasPermission("VCMI.bash.*");
	}
